(function() {
  ...
  (function(definition) {
    Parallelio.Map = definition();
    return Parallelio.Map.definition = definition;
  })(function(dependencies = {}) {
    var Element, Map;
    Element = dependencies.hasOwnProperty("Element") ? dependencies.Element : Parallelio.Spark.Element;
    Map = (function() {
  ...
  (function(definition) {
    Parallelio.StarMapGenerator = definition();
    return Parallelio.StarMapGenerator.definition = definition;
  })(function(dependencies = {}) {
    var Element, Map, Star, StarMapGenerator;
    Element = dependencies.hasOwnProperty("Element") ? dependencies.Element : Parallelio.Spark.Element;
    Map = dependencies.hasOwnProperty("Map") ? dependencies.Map : Parallelio.Map;
    Star = dependencies.hasOwnProperty("Star") ? dependencies.Star : Parallelio.Star;
    StarMapGenerator = (function() {
      class StarMapGenerator extends Element {
        ...
        createStars(nb) {
          var i, k, ref3, results;
          results = [];
          for (i = k = 0, ref3 = nb; (0 <= ref3 ? k < ref3 : k > ref3); i = 0 <= ref3 ? ++k : --k) {

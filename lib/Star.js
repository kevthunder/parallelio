(function(definition){var Star=definition(typeof Parallelio!=="undefined"?Parallelio:this.Parallelio);Star.definition=definition;if(typeof module!=="undefined"&&module!==null){module.exports=Star;}else{if(typeof Parallelio!=="undefined"&&Parallelio!==null){Parallelio.Star=Star;}else{if(this.Parallelio==null){this.Parallelio={};}this.Parallelio.Star=Star;}}})(function(dependencies){if(dependencies==null){dependencies={};}
var Element = dependencies.hasOwnProperty("Element") ? dependencies.Element : require('spark-starter').Element;
var Star, extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },

(function(definition){Floor=definition(typeof(Parallelio)!=="undefined"?Parallelio:this.Parallelio);Floor.definition=definition;if(typeof(module)!=="undefined"&&module!==null){module.exports=Floor;}else{if(typeof(Parallelio)!=="undefined"&&Parallelio!==null){Parallelio.Floor=Floor;}else{if(this.Parallelio==null){this.Parallelio={};}this.Parallelio.Floor=Floor;}}})(function(dependencies){if(dependencies==null){dependencies={};}
